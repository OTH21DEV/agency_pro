...
function ServiceCards() {
  ...
  let services = ["S", "E", "R", "V", "I", "C", "E", "S"];
  return (
    <section className="services-section">
    <div className="services-wrapper">
      <h2>02/</h2>
      <span className="title-wrapper">
      {services.map((lettre, key) => {
    ...
    <ServiceCard number ={"01"} title={"Design Services"} style={{borderTop:"2px solid grey",marginTop:"85px"}}></ServiceCard>
